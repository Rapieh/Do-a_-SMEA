          ...
          children: [
            Column(
              ...
              children: [
                ...
                Text("اِهْدِنَا الصِّرَاطَ الْمُسْتَقِيْمَ"),
                Text("اِهْدِنَا الصِّرَاطَ الْمُسْتَقِيْمَ"),
                Text(
            ...
            Text(' (3x)' 'أَسْتَغْفِرُ ٱللّٰهَ الْعَظِيْمَ'),
            Text(' (3x)'
            ...
            Text('(33x)' 'يَا اَللّٰهُ يَا قَدِيْمُ'),
            Text('(33x)' 'يَا سَمِيْعُ يَا بَصِيْرُ'),
            Text('(33x)' 'يَا مُبْدِعُ يَا خَالِقُ'),
            Text('(33x)' 'يَا حَفِيْظُ يَا نَصِيْرُ يَا وَكِيْلُ ياَ اللّٰهُ'),
            Text(' (33x)' 'يَا حَيُّ يَا قَيُّوْمُ بِرَحْمَتِكَ أَسْتَغِيْثُ'),
            Text('يَا لَطِيْفُ' ' (41x)'),
            Text('(33x) '
            ...
            Text('(41x) ' 'يَا بَدِيْعُ'),
            Text(' (33x)   ' 'حَسْبُنَا اللّٰهُ وَنِعْمَ الْوَكِيْلُ')
          ],
        ),
      ),
    );
